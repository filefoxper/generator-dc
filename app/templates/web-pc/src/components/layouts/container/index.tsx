...
export const SlideContainer = memo(({children, className}: ContainerProps) => {
  return (
...
export const Decorator = memo(
  ({title, desc, className}: DecoratorProps) => {
    return (
...
export const Developing = memo(
  ({title, className}: DevelopingProps) => {
    return (
